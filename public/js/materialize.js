...
(function ($, anim) {
  ...
  var Dropdown = function (_Component2) {
    ...
    function Dropdown(el, options) {
      ...
      _this8.filterQuery = []; // Move dropdown-content after dropdown-trigger
    ...
    _createClass(Dropdown, [{
      ...
      value: function _animateOut() {
        ...
        anim({
          ...
          easing: 'easeOutQuint',
          complete: function complete(anim) {
            _this11._resetDropdownStyles(); // onCloseEnd callback
...
(function ($, anim) {
  ...
  var Modal = function (_Component3) {
    ...
    _createClass(Modal, [{
      ...
      key: "_animateIn",
      value: function _animateIn() {
        var _this13 = this; // Set initial styles
      ...
      key: "_animateOut",
      value: function _animateOut() {
        var _this14 = this; // Animate overlay
        ...
        var exitAnimOptions = {
          ...
          complete: function complete() {
            ...
            _this14.$overlay.remove(); // Call onCloseEnd callback
...
(function ($, anim) {
  ...
  var Materialbox = function (_Component4) {
    ...
    function Materialbox(el, options) {
      ...
      _this15.caption = _this15.el.getAttribute('data-caption') || ''; // Wrap
    ...
    _createClass(Materialbox, [{
      ...
      value: function _animateImageIn() {
        ...
        var animOptions = {
          ...
          easing: 'easeOutQuad',
          complete: function complete() {
            _this16.doneAnimating = true; // onOpenEnd callback
      ...
      value: function _animateImageOut() {
        ...
        var animOptions = {
          ...
          complete: function complete() {
            ...
            _this17.$el.attr('style', _this17.originInlineStyles); // Remove class


            _this17.$el.removeClass('active');

            _this17.doneAnimating = true; // Remove overflow overrides on ancestors
...
(function ($, anim) {
  ...
  var Tabs = function (_Component6) {
    ...
    function Tabs(el, options) {
      ...
      _this21.options = $.extend({}, Tabs.defaults, options); // Setup
    ...
    _createClass(Tabs, [{
      ...
      value: function _handleTabClick(e) {
        ...
        this._setTabsAndTabWidth(); // Make the old tab inactive.
      ...
      value: function _setupSwipeableTabs() {
        var _this24 = this; // Change swipeable according to responsive threshold
...
(function ($, anim) {
  ...
  var Sidenav = function (_Component8) {
    ...
    function Sidenav(el, options) {
      ...
      _this30.isDragged = false; // Window size variables for window resize checks
...
(function ($, anim) {
  ...
  var ScrollSpy = function (_Component9) {
    ...
    function ScrollSpy(el, options) {
      ...
      _this34.options = $.extend({}, ScrollSpy.defaults, options); // setup
...
(function ($) {
  ...
  var Autocomplete = function (_Component10) {
    ...
    function Autocomplete(el, options) {
      ...
      _this36.options = $.extend({}, Autocomplete.defaults, options); // Setup
...
(function ($, anim) {
  ...
  var Slider = function (_Component11) {
    ...
    function Slider(el, options) {
      ...
      _this39.options = $.extend({}, Slider.defaults, options); // setup
      ...
      _this39._setSliderHeight(); // Set initial positions of captions
      ...
      _this39._setupIndicators(); // Show active slide
      ...
      if (_this39.$active) {
        ...
        _this39.$active = _this39.$slides.eq(_this39.activeIndex); // Update indicators
      ...
      _this39._setupEventHandlers(); // auto scroll
    ...
    _createClass(Slider, [{
      ...
      value: function set(index) {
        var _this43 = this; // Wrap around indices.
...
(function ($) {
  ...
  var Chips = function (_Component12) {
    ...
    function Chips(el, options) {
      ...
      _this44.hasAutocomplete = Object.keys(_this44.options.autocompleteOptions).length > 0; // Set input id
...
(function ($) {
  ...
  var Datepicker = function (_Component15) {
    ...
    function Datepicker(el, options) {
      ...
      _this52.options = $.extend({}, Datepicker.defaults, options); // make sure i18n defaults are not lost when only few i18n option properties are passed
...
(function ($) {
  ...
  var Carousel = function (_Component18) {
    ...
    function Carousel(el, options) {
      ...
      _this61.options = $.extend({}, Carousel.defaults, options); // Setup
      ...
      _this61._trackBound = _this61._track.bind(_this61); // Full Width carousel setup

      if (_this61.options.fullWidth) {
        _this61.options.dist = 0;

        _this61._setCarouselHeight(); // Offset fixed items when indicators.
      ...
      _this61.count = _this61.images.length; // Cap numVisible at count

      _this61.options.numVisible = Math.min(_this61.count, _this61.options.numVisible); // Setup cross browser string
    ...
    _createClass(Carousel, [{
      ...
      value: function _scroll(x) {
        var _this65 = this; // Track scrolling state
...
(function ($) {
  ...
  var FormSelect = function (_Component20) {
    ...
    function FormSelect(el, options) {
      ...
      _this67.isMultiple = _this67.$el.prop('multiple'); // Setup
...
(function ($, anim) {
  ...
  var Range = function (_Component21) {
    ...
    function Range(el, options) {
      ...
      _this71._mousedown = false; // Setup
...
module.exports = __webpack_require__(/*! /Users/tky/Myapp/php/gutitter/resources/js/materialize.js */"./resources/js/materialize.js");
